...
exec_r1 "ip link add vxlan10 type vxlan id 10 dstport 4789 group 239.1.1.1 local 10.1.1.1 dev eth0"
...
exec_r2 "ip link add vxlan10 type vxlan id 10 dstport 4789 group 239.1.1.1 local 10.1.1.2 dev eth0"
