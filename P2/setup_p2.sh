...
R1="GNS3.router_ponchon-1.${PROJECT_ID}"
R2="GNS3.router_ponchon-2.${PROJECT_ID}"
H1="GNS3.host_ponchon-1.${PROJECT_ID}"
H2="GNS3.host_ponchon-2.${PROJECT_ID}"
...
exec_h1 "ip addr add 30.1.1.10/24 dev eth0"
exec_h1 "ip link set eth0 up"

log "HOST 2 - IP"
exec_h2 "ip addr flush dev eth0"
exec_h2 "ip addr add 30.1.1.20/24 dev eth0"
